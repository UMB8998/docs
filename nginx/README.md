...
### Using environment variables in mips64le/nginx configuration

Out-of-the-box, mips64le/nginx doesn't support environment variables inside most configuration blocks. But `envsubst` may be used as a workaround if you need to generate your mips64le/nginx configuration dynamically before mips64le/nginx starts.
